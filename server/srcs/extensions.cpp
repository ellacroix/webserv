...
const std::pair<std::string, std::string> Response::document_type[104] = {
	...
	std::pair<std::string, std::string>("docx",
			"application/vnd.openxmlformats-officedocument.wordprocessingml.document"),
	std::pair<std::string, std::string>("xlsx",
			"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"),
	std::pair<std::string, std::string>("pptx",
			"application/vnd.openxmlformats-officedocument.presentationml.presentation"),
	std::pair<std::string, std::string>("mid",
			"application/vnd.openxmlformats-officedocument.presentationml.presentation"),
	std::pair<std::string, std::string>("midi",
			"application/vnd.openxmlformats-officedocument.presentationml.presentation"),
